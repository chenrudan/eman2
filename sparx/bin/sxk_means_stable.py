...
def main():
	...
	(options, args) = parser.parse_args()
		...
		if options.MPI:
			...
			'''if options.CUDA:
				from EMAN2.development import k_means_stab_MPICUDA_stream_YANG
			...
			from EMAN2.statistics import k_means_stab_MPI_stream
			...
			'''if options.CUDA:
				from EMAN2.development import k_means_stab_CUDA_stream
			...
			from EMAN2.statistics import k_means_stab_stream
