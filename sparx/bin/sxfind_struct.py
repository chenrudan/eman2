...
def main():
	...
	if len(args) != 2:
		...
		if global_def.CACHE_DISABLE:
			...
			disable_bdb_cache()
		if options.MPIGA:
			from EMAN2.development import cml2_main_mpi
			...
			from EMAN2.applications import cml_find_structure_MPI2
			global_def.BATCH = True
			...
			from EMAN2.applications import cml_find_structure_main
			global_def.BATCH = True
