...
def main():
	...
	if len(args) != 2:
		...
		from EMAN2.applications import ali_vol_scale
		...
		from EMAN2.applications import ali_vol_only_scale
		global_def.BATCH = True
		...
		from EMAN2.applications import ali_vol_shift
		global_def.BATCH = True
		...
		from EMAN2.applications import ali_vol_rotate
		global_def.BATCH = True
