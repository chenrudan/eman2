...
def main():
	...
	if len(args) < 1  or len(args) > 4:
		...
		from sparx.utilities import convertasi,prepare_ptp,print_dict,get_resolution_mrk01,partition_to_groups,partition_independent_runs,get_outliers
		...
		from sparx.utilities import print_a_line_with_timestamp, split_a_group
