...
class TestCorrelationFunctions(unittest.TestCase):
	...
	def internal_test_image2(self, nx, ny=1, nz=1):
		...
		from EMAN2.fundamentals import cyclic_shift, mirror
		e = EMData()
		e.set_size(nx, ny, nz)
		e.process_inplace("testimage.tomo.objects")
	...
	def test_acf_circle_2D_20x30(self):
		...
		from EMAN2.fundamentals import acf, acfn, acfnp, acfnpl, acfp, acfpl
	...
	def test_ccf_circle_2D_20x30(self):
		...
		from EMAN2.utilities import model_circle
		from EMAN2.fundamentals import ccf, ccfn, ccfnp, ccfnpl, ccfp, ccfpl
		A = model_circle(7, 20, 30)
...
'''
	def test_cnv_circle_2D_20x30(self):
		...
		from EMAN2.utilities import model_circle
		from EMAN2.fundamentals import cnv, cnvn, cnvnp, cnvnpl, cnvp, cnvpl, mirror
		A = model_circle(7, 20, 30)
		B = model_circle(4, 20, 30)
