...
def align_diff_params(ali_params1, ali_params2):
	...
	from sparx.utilities import combine_params2
...
def pixel_error_angle_sets(agls1, agls2, Threshold=1.0e23, r=1.0):
	...
	from sparx.utilities import read_text_file, rotation_between_anglesets
	import types
...
def rotate_angleset_to_match(agls1, agls2):
	...
	from sparx.utilities import rotation_between_anglesets, angle_between_projections_directions
...
def mapcoords(x, y, r, nx, ny):
	...
	from sparx.utilities import get_dist
	import sys
	'''
	Input:
...
def consistency_params(stack, dphi, dp, pixel_size, phithr=2.5, ythr=1.5, THR=3):
	...
	'''
	from sparx.utilities import read_text_row, write_text_row, get_dist
	from sparx.applications import ordersegments
	from sparx.pixel_error import angle_diff
...
def getnewhelixcoords(hcoordsname, outdir, ratio,nx,ny, newpref="resampled_", boxsize=-1):
	...
	import os
	from sparx.utilities import read_text_row
	from sparx.pixel_error import mapcoords
...
def estimate_stability(data1, data2, CTF=False, snr=1.0, last_ring=-1):
	...
	from sparx.statistics import sum_oe, ccc
