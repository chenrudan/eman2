...
def filt_vols( vols, fscs, mask3D ):
	from math import sqrt
	from sparx.filter import fit_tanh, filt_tanl, filt_table
	from sparx.fundamentals import rops_table
...
def filterlocal(ui, vi, m, falloff, myid, main_node, number_of_proc):
	...
	from sparx.utilities import bcast_number_to_all, bcast_list_to_all, model_blank, bcast_EMData_to_all, reduce_EMData_to_root
	from sparx.morphology import threshold_outside
	from sparx.filter import filt_tanl
	from sparx.fundamentals import fft, fftip
