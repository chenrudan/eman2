...
def get_3d_font_renderer():
	try:
		...
		if pfm in ["Linux","Darwin"]:
			font_renderer.set_font_file_name("{}/fonts/DejaVuSerif.ttf".format(os.getenv("EMAN2DIR")))
		elif pfm == "Windows":
