...
setup(
    ...
    package_data={'EMAN2':['examples/*.py','fonts/*.txt','fonts/*.tff','images/*.png','images/*.ico','pmconfig/*.json','pyemtbx/*.py','doc/*'],'':['include/*.h','include/gorgon/*.h','include/plugins/*.h','test/rt/*.py']},
